\begin{figure}[!h]
  ...
  \caption{\textbf{Treatments preserving slip-duplicated content facilitate adaptive evolution.}
    ...
    Asterisk (*) markers indicate treatments with significantly higher phenotypic adaptation scores compared to baseline, comparison across both panels \ref{fig:results_panels:slip_duplication} and \ref{fig:results_panels:ablation}.
