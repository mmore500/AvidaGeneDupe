...
Panel \ref{fig:potentiation-supp:excluding-copy-loop} shows coding site enrichment for \textit{de novo} logic-9 tasks in slip-duplicated regions, excluding sites assessed by knockout analysis as critical to self-copy loop viability.
