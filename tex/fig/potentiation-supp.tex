...
\includegraphics[width=\textwidth]{binder/binder/teeplots/density-norm=width+hue=components+viability=exclude+viz=violinplot+x=components+y=is-task-coding-site+ext=.pdf}
\caption{%
\footnotesize
...
\begin{subfigure}{0.5\textwidth}
\includegraphics[width=\textwidth]{binder/binder/teeplots/density-norm=width+hue=components+slipgain=only+viz=violinplot+x=components+y=is-task-coding-site+ext=.pdf}
\caption{%
\footnotesize
