\begin{figure*}
    ...
    \caption{
        ...
        \textit{Slip-duplicate}, which incorporates gene duplication mutations, produces faster adaptive evolution than long-genome treatment for more complex tasks that require 4 or 5 NAND operations.
