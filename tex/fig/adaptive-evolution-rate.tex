\begin{figure*}
    ...
    \caption{
        ...
        \textit{Slip-duplicate}, which allows gene duplication mutations, produces faster adaptive evolution than the long-genome control only for complex tasks that require 4 or 5 NAND operations.
