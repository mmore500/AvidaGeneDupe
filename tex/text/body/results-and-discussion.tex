...
Comparing the acquisition of phenotypic traits between slip-duplicate-enabled and baseline treatments, we found slip duplication to yield evolution of significantly more adaptive phenotypic traits (two-tailed Mann-Whitney U test, $W = 562.5$, Bonferroni-adjusted $p << 0.0001$; Figure \ref{fig:results_panels}).
