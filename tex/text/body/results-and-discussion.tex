...
Specifically, we examined the role of adaptive processes, such as neofunctionalization, in shaping gene duplication's impact on the evolution of a range of adaptive traits with varied requisite genetic complexity (Figure \ref{fig:slip_mut_variants}).
...
However, this effect is limited to phenotypic traits with the greatest genetic complexity (i.e., requiring the greatest number of genetic subcomponents), with the adaptive evolution of simpler traits exhibiting no benefit beyond the effect of increased genome size alone.
...
Among many other examples \citep{zhang2002adaptive,gaines2009gene,perry2007diet,hittinger2007gene,benderoth2006positive,dulai1999evolution}, such observations motivate longstanding connections drawn between gene duplications and adaptive traits, which date as far back as \citet{ohno1970evolution}.
Here, systematic and controlled experimental evidence provides valuable corroboration for this understanding --- and, additionally, suggests in further detail that gene duplications may be especially important to the evolution of traits that require complex genetic machinery and not necessarily those with simpler genetic underpinnings.
% @AML: Maybe phrase the above as mutational steps?

% -- Information content of duplications provides adaptive benefit --
Our digital evolution study system allowed us to further disentangle what characteristics of gene duplications increase evolutionary potential by imposing variants of the slip mutation operator (Figure~\ref{fig:slip_mut_variants}), each designed to isolate a particular aspect of slip-duplication mutations.
...
These results indicate that both the content and structure of duplicated genetic material contribute to facilitating adaptive evolution rather than other characteristics of duplications.
...
Thus, the adaptive characteristics of slip duplication observed in our system seem likely to result from a combination of potentiation via neo-functionalization and direct facilitation.
Indeed, in nature, large-scale genomic analyses have discovered cases where a strikingly high fraction of the genes in an organism show evidence of having arisen from gene duplications \citep{teichmann_structural_1998,Teichmann:2004cz}.
...
In line with evidence that duplication-associated redundancy can boost robustness \citep{Lynch2000}, we found that fitness-neutral slip insertions did indeed tend to reduce the number of genome sites detectable as a single point of failure for performed tasks.
Within our study system, slip duplication appears to increase the net supply of coding material in the genome available to neutral processes, but not significantly affect accumulation of genetic brittleness.
One possible explanation is that selective pressures are driving the two treatments to reach a similar number of critical sites, but slip duplication can duplicate and copy genome content in a manner that increases the copy count of previously coding sites relative to the number of critical sites.
Comparative studies have associated duplication events early in natural history with increases in genetic robustness and evolutionary innovation \citep{Wagner2008}.
