...
Specifically, we examined the hypothesis that gene duplication acts in shaping adaptive evolution of complex trait.
To conduct these experiments, TODO (Figure \ref{fig:slip_mut_variants}).
We find that gene duplication promotes the \textit{de novo} evolution of complex phenotypic traits via neo-functionalization.
However (TODO transition to novelty), this effect is limited to phenotypic traits with the greatest genetic complexity (i.e., requiring the greatest number of genetic subcomponents), with the adaptive evolution of simpler traits exhibiting no benefit beyond the effect of increased genome size alone (Figure \ref{fig:adaptive-evolution-rate}).

% -- Discussion: Gene duplication facilitates adaptive evolution of complex traits --
