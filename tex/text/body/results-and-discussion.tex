...
Step-by-step lineage analysis revealed that duplicated content disproportionately contributed to novel complex traits (Figure~\ref{fig:potentiation}).
Specifically, many coding sites for newly gained adaptive traits traced back to duplicated regions, and 41 of 174 gain-of-function mutations along analyzed lineages directly coincided with slip duplications.
Together, these patterns suggest that the adaptive characteristics of slip duplication in our system stem from a combination of direct facilitation and later potentiation (e.g., via neo-functionalization).
...
These results are consistent with long-standing hypotheses that gene duplications can drive evolutionary innovation, particularly for traits requiring multiple interacting components, though further work is needed to assess how well our digital system reflects natural organisms.
