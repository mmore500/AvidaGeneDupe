...
% @AML: This last point feels incomplete. Is it meant to flow into/motivate the next subsection? Or, meant to position the results in this subsection within the broader literature?
%  - As-is the sentence structure has too many breaks (Although, however, in particular).
%  - Could break up to ease readability, slightly expand/strengthen point a little by explicitly pointing out that this is the first (to our knowledge) experiment directly comparing effects of gene duplication on evolution of complex adaptive traits _vs_ simple traits.
