...
Step-by-step lineage analyses showed that duplicated content disproportionately contributed to novel complex traits: many coding sites for newly gained traits traced back to duplicated regions, and 41 of 174 gain-of-function mutations coincided with slip duplications (Figure~\ref{fig:potentiation}).
Thus, slip duplications in our system appear to both directly produce functional sequences and potentiate later co-option (e.g., neo-functionalization).
...
These findings are consistent with long-standing hypotheses that gene duplications contribute to evolutionary innovation and help explain how duplications can increase evolvability, particularly for traits requiring multiple interacting components.
