...
While we find that gene duplication can facilitate adaptive evolution, we detect this effect only for phenotypic traits with greater functional complexity; adaptive evolution of simpler traits exhibit no benefit beyond the effect of increased genome size alone (Figure \ref{fig:adaptive-evolution-rate}).
Given compositional nature of trait functionality within our study system \citep{Lenski2003Evolutionary}, this outcome would be consistent suggestive with a ``building block'' model of adaptation, where duplication facilitates discovery of novel medleys of existing components.
...
Among many other examples \citep{zhang2002adaptive,gaines2009gene,perry2007diet,hittinger2007gene,benderoth2006positive,dulai1999evolution}, such observations provide a basis for longstanding connections drawn between gene duplications and adaptive traits, dating as far back as \citet{ohno1970evolution}.
Present work contributes systematic and controlled experimental evidence supporting this relationship, and additionally suggests in further detail that gene duplications may be especially important to the evolution of complex traits.
However, further work is warranted investigating whether similar constraints or patterns hold in natural systems where additional mechanisms --- such as structured regulatory interactions --- play prominent roles in trait evolution.
...
These results indicate that both the content and structure of duplicated genetic material contribute to facilitating adaptive evolution, beyond the impact of side effects such as increase in genome size or mutational supply.
...
Given that comparative studies have linked ancient duplication events with subsequent gains in genetic robustness and evolutionary innovation \citep{Wagner2008}, these findings suggest directions for future work experimental investigating how such dynamics unfold over extended timescales to shed light on possible connections to larger-scale evolutionary patterns.
