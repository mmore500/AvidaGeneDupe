...
In contrast to purely neutral framings of biological complexity, our results support gene duplication events as an contributing factor in aadaptive origins of complex traits.
\end{abstract}
