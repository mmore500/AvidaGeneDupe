...
% [x] @CAO: This last line feels outside the scope of this paper; I think it's a fine thing to say in the body, but the abstract should end with a line about what our results mean in a broader context.  Perhaps most specific follow-up topics that can now be addressed, or maybe a link to the EC side of things where we can apply this ideas for more rapid problem solving.
\end{abstract}
