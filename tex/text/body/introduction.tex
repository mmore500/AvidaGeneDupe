...
These adaptive coding sites were identified through single-site knockout screens, disabling genome instructions one-by-one by substitution with a null placeholder.
\unskip\footnote{%
