...
In recent years, experimental approaches --- which can explicitly test causality --- have become an important complement to observational studies of natural history \citep{Kawecki2012,Elena2003}.
...
Comparing evolution of fluorescence phenotypes between single- and double-copy coGFP populations, double-copy populations exhibited greater robustness under mutation but no faster adaptation under selection.
...
With respect to both these functional and structural complexity metrics, we find that gene duplication can systematically increase evolved complexity.
...
Thus, we also confirm that gene duplication can facilitate otherwise unlikely complex innovation in adaptation-driven scenarios \citep{ohno1970evolution}.
