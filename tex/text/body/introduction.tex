...
By expressing this protein in a different context, the cell gained access to a resource that it previously could not metabolize, resulting in a 7-fold increase in population size. %and a greater ability to explore nearby beneficial mutations.
...
% Or is it that the mutations are insertions that provide evolution with an easy technique to select for longer genomes and increased information storage capacity?
