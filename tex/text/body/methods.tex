...
First-phase experiments consisted of seven treatments: one baseline treatment with slip-duplication disabled, five experimental treatments corresponding to the five surveyed slip-duplication mutation operators shown in Figure \ref{fig:slip_mut_variants}, and a high mutation rate control.
