...
On account of an earlier experimental design incorporating two additional surveyed conditions incorporating environmental flucatuations, Bonferroni correction was applied to keep experiment-wise $\alpha$ = 0.05.
...
Experimental design in our second-phase experiments did not require adjustments for multiple comparison.
