...
def makeTidy(treatmentName,treatmentData):
    with open('{}TaskCounts.csv'.format(treatmentName), mode='w') as tidyDat:
...
for treatment in Treatments:
    ...
    for runDir in treatment.runDirectories:
        treatmentData.append(os.path.join(runDir,"data/detail_MostNumLineage.dat"))

    makeTidy(treatment.treatmentName,treatmentData)
