...
#SBATCH --job-name=LalejiniEtAlWLogic25HighReplicateCountHigh-Mutation
...
USERNAME=clhaynes
EXPERIMENT_ID=2022-5-21-LalejiniEtAlWLogic25HighReplicateCount
OUTPUT_DIR=/scratch/zamanlh_root/zamanlh0/${USERNAME}/${EXPERIMENT_ID}/High-Mutation
...
EXECUTE="avida -s ${SEED} -set COPY_MUT_PROB 0.0025 -set COPY_INS_PROB 0.0075 -set COPY_DEL_PROB 0.0075 -set DIVIDE_INS_PROB 0.05 -set DIVIDE_DEL_PROB 0.05 -set DIVIDE_SLIP_PROB 0.05 -set SLIP_FILL_MODE 0"
